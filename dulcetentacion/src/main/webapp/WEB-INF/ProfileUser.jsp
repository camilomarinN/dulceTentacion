...
<div id="wrapper" class="position-relative" style="min-height:100%;">
	<header>
		...
		<main class="container pt-5 mt-4" style="margin-bottom: 130px;">
	    <div class="row d-flex p-4 rounded shadow-lg" style="background-color: #F0DEDE !important;">
	      <div class="col-lg-4">
	        ...
	        <div class="row">
	          ...
	          <div class="col-md-6">
	            <div class="card mb-4 mb-md-0">
	              <div class="card-body">
	                <p class="mb-4">Pedidos</p>
	                <p class="mb-1" style="font-size: .77rem;">Pedidos Facturados</p>
	                <div class="progress rounded" style="height: 5px;">
	                  <div class="progress-bar" role="progressbar" style="width: 80%" aria-valuenow="80"
	                    aria-valuemin="0" aria-valuemax="100"></div>
	                </div>
	                <p class="mt-4 mb-1" style="font-size: .77rem;">Pedidos cancelados</p>
	                <div class="progress rounded" style="height: 5px;">
	                  <div class="progress-bar" role="progressbar" style="width: 20%" aria-valuenow="20"
	                    aria-valuemin="0" aria-valuemax="100"></div>
	                </div>
	                <p class="mt-4 mb-1" style="font-size: .77rem;">Total de ordenes</p>
	                <p>40</p>
	              </div>
	            </div>
	          </div>
